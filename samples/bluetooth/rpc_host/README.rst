...
On the nRF53 device, this sample is supposed to run on the network core and it provides the Bluetooth LE functionality for the application core.
...
The host (network core) is running full Bluetooth LE stack.
...
You can build the sample with a debugging configuration.
